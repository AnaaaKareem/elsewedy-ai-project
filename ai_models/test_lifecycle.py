...
def test_lifecycle():
    ...
    for i in range(1, 21):
        ...
        if i % 5 == 0:
            assert os.path.exists("weights/shielding_lstm_checkpoint.pth")
    ...
    for i in range(1, 11):
        ...
        if i % 5 == 0:
            assert os.path.exists("weights/polymer_xgb_checkpoint.pkl")
    ...
    for i in range(1, 11):
        ...
        if i % 5 == 0:
            assert os.path.exists("weights/screening_croston_checkpoint.npy")
